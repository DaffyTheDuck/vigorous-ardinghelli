...
// import "./HomePage.css";
// import TagInput from "./FilterTag/TagInput"; // Assuming TagInput component exists

// // Hardcoded initial data for the table
// const initialData = [
//   { id: 1, name: "John Doe" },
...
//   // This effect runs whenever the searchTerm changes, filtering the table data
//   useEffect(() => {
...
//       {/* New container for the 50-50 split controls */}
